...
namespace IMS
{
    public partial class Faculty : Form
    {
        ...
        private void Faculty_Load(object sender, EventArgs e)
        {
            ...
            obj.bindCombo(query, cname, "fname", "fid");
        }
        ...
        {
            if (cname.Text == "" || fname.Text == "" || doby.Text == "" || dobm.Text == "" || dobd.Text == "" || contact.Text == "" || email.Text == "" || address.Text == "" || qualification.Text == "" || experiance.Text == "" || sub.Text == "" || jy.Text == "" || jm.Text == "" || jd.Text == "")
            {
            ...
            {
                query = "insert into tblfaculty values('" + cname.Text + "','" + fname.Text + "','" + doby.Text + "','" + dobm.Text + "','" + dobd.Text + "','" + contact.Text + "','" + email.Text + "','" + qualification.Text + "','" + experiance.Text + "','" + sub.Text + "','" + jy.Text + "','" + jm.Text + "','" + jd.Text + "','" + email.Text + "','" + address.Text + "')";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                query = "update tblfaculty set ffname='" + fname.Text + "',fdoby='" + doby.Text + "',fdobm='" + dobm.Text + "' ,fdobd='" + dobd.Text + "' ,fcontact='" + contact.Text + "',feadd='" + email.Text + "',fadd='" + address.Text + "',fqauali='" + qualification.Text + "',fexper='" + experiance.Text + "',fjy='" + jy.Text + "',fjm='" + jm.Text + "',fjd='" + jd.Text + "',fsubject='" + sub.Text + "'  where fname='" + cname.Text + "'";
        ...
        {
            query = "select * from tblfaculty where fid='" + cname.SelectedValue + "'";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    query = "delete from tblfaculty where fid='" + cname.SelectedValue + "'";
