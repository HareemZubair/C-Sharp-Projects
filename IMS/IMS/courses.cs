...
namespace IMS
{
    public partial class courses : Form
    {
        ...
        private void comboBox1_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            obj.bindTextBox(query, textBox3, "cttfess");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                query = "update tblcourses set cduration='" + comboBox2.Text + "',ctype='" + comboBox3.Text + "',cttfess='" + textBox3.Text + "',cadfee='" + textBox4.Text + "' ,cmfees='" + textBox5.Text + "' ,clumpsum='" + textBox6.Text + "'  where cname='" + comboBox1.Text + "'";
