...
namespace IMS
{
    public partial class fees : Form
    {
        ...
        private void comboBox1_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            query = "select * from tblfees where sid = "+comboBox1.Text+"";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (namelbl.Text == "" || fnamelbl.Text == "" || afee.Text == "" || duration.Text == "" || mon.Text == "" || lumpsum.Text == "" ||  label13.Text == "" || comboBox1.Text == "" ||monp.Text=="" || lumpsumpaid.Text==""||feem.Text==""||mfee.Text=="")
            {
