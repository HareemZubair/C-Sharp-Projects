...
namespace IMS
{
    public partial class Faculty : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                query = "update tblfaculty set ffname='" + fname.Text + "',fdoby='" + doby.Text + "',fdobm='" + dobm.Text + "' ,fdobd='" + dobd.Text + "' ,fcontact='" + contact.Text + "',feadd='" + email.Text + "',fadd='" + address.Text + "',fquali='" + qualification.Text + "',fexper='" + experiance.Text + "',fjy='" + jy.Text + "',fjm='" + jm.Text + "',fjd='" + jd.Text + "',fsubject='" + sub.Text + "'  where fname='" + cname.Text + "'";
