...
namespace IMS
{
    public partial class student : Form
    {
        ...
        private void student_Load(object sender, EventArgs e)
        {
            ...
            query = "SELECT     tblstud.sid, tblstud.sname, tblstud.sfname, tblstud.sdoby, tblstud.sdobm, tblstud.sdobd, tblstud.semail, tblstud.scontact, tblstud.saddress, tblcourses.cname, tbltime.ttime,tblsession.sname, tblstud.saddate FROM tblstud INNER JOIN tbltime ON tblstud.tid = tbltime.tid INNER JOIN tblsession ON tblstud.sessionid = tblsession.sessionid INNER JOIN tblcourses ON tblstud.cid = tblcourses.cid";
        ...
        private void comboBox1_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            query = "SELECT     tblstud.sid, tblstud.sname, tblstud.sfname, tblstud.sdoby, tblstud.sdobm, tblstud.sdobd, tblstud.semail, tblstud.scontact, tblstud.saddress, tblcourses.cname, tbltime.ttime,tblsession.sname, tblstud.saddate FROM tblstud INNER JOIN tbltime ON tblstud.tid = tbltime.tid INNER JOIN tblsession ON tblstud.sessionid = tblsession.sessionid INNER JOIN tblcourses ON tblstud.cid = tblcourses.cid where sname='" + comboBox1.SelectedValue + "'";
            ...
            obj.bindTextBox(query, textBox4, "scontact");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                query = "insert into tblstud values(" + Idlbl.Text + ",'" + comboBox1.Text + "','" + textBox2.Text + "','" + doby.Text + "','" + dobm.Text + "','" + dobd.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "'," + id + "," + tid + "," + sid + ",'" + label11.Text + "')";
